...
The user wants to master Retrieval-Augmented Generation (RAG), AI agents, Spec-Driven Development, and multi-agent orchestration through a hands-on, 6-day project based on their previous Kaggle Capstone Project. This proposal establishes a structured, spec-driven roadmap and architecture to guide the development and integration of these components within a 6-day timeline leading to the Kaggle submission.
...
- **Interactive Multi-Agent UI**: A Next.js 16/React 19 web application (`Multi-Agent UI`) allowing selection of various model providers (OpenAI, Anthropic, Google) and local RAG.
...
- **6-Day Curriculum Structure**: A structured milestone plan with daily tasks, verification harnesses, and Kaggle submission deliverables.
